...
Files: macbook-16.glb [639.28KB] > C:\Users\ko2ch\WebstormProjects\macbook-gsharp-app\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookMode16(props) {
    ...
    useEffect(() => {
        scene.traverse((child) => {
            if(child.isMesh){
                // Change only if the part is a change part is in noChangeParts
